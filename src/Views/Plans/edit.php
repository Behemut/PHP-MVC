...
<div class="pb-5 w-full h-full">
    ...
    <form action="<?php $_SERVER['REQUEST_URI'] ?>" method="post" class="bg-slate-300 w-1/2 mx-auto p-5 rounded-lg mb-5">
        <div class="w-full">
            <input type="hidden" name="codigo" value="<?php echo $plans['codigo'] ?>">
            <div class="flex flex-col mb-4">
                <label class="mb-2 uppercase font-bold text-lg text-slate-600">Descripcion</label>
                <input class="border py-2 px-3 text-grey-darkest" type="text" name="descripcion" value="<?php echo $plans['descripcion'] ?>">
            </div>
