        ...
        <table class="border-separate table-auto w-full border border-slate-200 dark:border-slate-100 bg-white dark:bg-slate-100 text-sm shadow-sm">
            ...
            <tbody>
                ...
                foreach ($customers as $customer) {
                    ...
                    echo "<td class='border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-red-800 cursor-pointer font-bold' ><a href='" . $_ENV['HOST'] . "/delete/customer?id=" . $customer['codigo'] . "'> <i class='fa-solid fa-trash text-red-600'></i>  Eliminar  </a></td>";
                    echo "<td class='border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-green-600 cursor-pointer font-bold' ><a href='" . $_ENV['HOST'] . "/edit/customer?id=" . $customer['codigo'] . "'> <i class='fa-solid fa-pen-to-square text-green-600'></i>  Editar </a></td>";
